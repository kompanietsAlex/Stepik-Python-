...
class LinkedGraph:
    ...
    def add_vertex(self, v):
        """добавления новой вершины v
        в список _vertex если она там отсутствует)"""
        if v not in self._vertex:
            self._vertex.append(v)

    def add_link(self, link):
        """добавления новой связи link в список _links если
        объект link с указанными вершинами в списке отсутствует"""
    ...
    def find_path(self, start_v, stop_v):
        """для поиска кратчайшего маршрута из
